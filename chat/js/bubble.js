...
let messages = [
  ...
  },
  {
    who: "",
    type: "text",
    text: "2. Galimų sprendimų generavimas:- Daugiau praleisti laiko prie namų darbų; - Prašyti korepetitoriaus pagalbos; - Pakeisti mokymosi modelį;",
    time: 3500,
  },
  {
    who: "",
    type: "text",
    text: "3. Įvertinkite sprendimą Pavyzdžiui, “Daugiau praleist laiko prie namų darbų”.",
    time: 3500,
  },
  {
    who: "",
    type: "text",
    text: "4. Įgyvendinkite geriausią sprendimą: Norėdami gauti geresnius pažymius, būtina įsigyti knygų ir jas išsistudijuoti.",
    time: 3500,
  },
  {
    who: "",
    type: "text",
    text: "5. Įvertinkite rezultatą ir nuspręskite, ar sprendimas buvo sėkmingas: Ar pažymiai pagerėjo? Taip? Ne? Jei ne, darykite viską iš naujo tik rinkitės kitą sprendimo būdą.",
    time: 3500,
  },
  {
    who: "",
